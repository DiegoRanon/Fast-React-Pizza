...
export default function Button({ children, disabled, to, type, onClick }) {
  ...
  const styles = {
    ...
    secondary:
      "border-2 border-stone-300 uppercase font-semibold hover:text-stone-400 text-stone-800  inline-block tracking-wide rounded-full hover:bg-stone-800 transition-colors duration-300 focus:outline-none focus:ring focus:ring-stone-300 focus:bg-stone-300 focus:ring-offset-2 disabled:cursor-not-allowed px-4 py-2.5 md:px-6 md:py-3.5",
  };
  if (to)
    return (
